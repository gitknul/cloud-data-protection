...
{
    public class EmployeeRepositoryBenchmark10000<TFixture> : EmployeeRepositoryBenchmarkBase where TFixture : IEmployeeRepositoryBenchmarkFixture, new()
    {
        ...
        [GlobalSetup]
        public void Setup() => Fixture.Seed(nameof(EmployeeRepositoryBenchmark10000<TFixture>), 10000);

        [GlobalCleanup]
        public void Cleanup() => Fixture.TearDown();

        [IterationSetup]
        public void IterationSetup() => Repository = Fixture.GetRepository(nameof(EmployeeRepositoryBenchmark10000<TFixture>));
